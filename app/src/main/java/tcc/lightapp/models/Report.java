...
public class Report {
    ...
    public Report(long timestamp, String userUid, int positiveWords, int negativeWords, int neutralWords, int classifiedWords, int notClassifiedWords, int totalWords) {
